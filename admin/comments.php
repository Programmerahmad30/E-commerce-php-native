...
if (isset($_SESSION['Username']))
{
    ...
    if ($do == 'Manage'){//Manage Members Page
                    ...
                    <table class="main-table text-center table table-bordered">
                        ...
                        foreach ($comments as $comment)
                        {
                            ...
                            echo "<td>
                                                    ...
                                                    <a href='comments.php?do=Delete&comid=" . $comment['c_id'] . "' class='btn btn-danger confirm'><i class='fa fa-closed-captioning'></i> Delete</a>";

                            if ($comment['status'] == 0)
                            {
                                echo "<a 
                                        href='comments.php?do=Approved&comid=" . $comment['c_id'] . "' 
        ...
        else
        {
            echo '<div class="container">';
                echo '<div class="nice-message">Thers\`s No Comments To Show</div>';
            echo '</div>';
        }
        ?>
        <?php
    ...
    { //Edit Page
        ...
        //Check iF GET Request Comid Numeric & GET The Integer Value Of It
